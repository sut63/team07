...
func (iu *InsuranceUpdate) AddInsuranceofIDs(ids ...int) *InsuranceUpdate {
	iu.mutation.AddInsuranceofIDs(ids...)
	return iu
}

// AddInsuranceof adds the insuranceof edges to Ambulance.
func (iu *InsuranceUpdate) AddInsuranceof(a ...*Ambulance) *InsuranceUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return iu.AddInsuranceofIDs(ids...)
}
...
func (iu *InsuranceUpdate) RemoveInsuranceofIDs(ids ...int) *InsuranceUpdate {
	iu.mutation.RemoveInsuranceofIDs(ids...)
	return iu
}

// RemoveInsuranceof removes insuranceof edges to Ambulance.
func (iu *InsuranceUpdate) RemoveInsuranceof(a ...*Ambulance) *InsuranceUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return iu.RemoveInsuranceofIDs(ids...)
}
...
func (iu *InsuranceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := iu.mutation.RemovedInsuranceofIDs(); len(nodes) > 0 {
	...
	if nodes := iu.mutation.InsuranceofIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   insurance.InsuranceofTable,
...
// SetCompany sets the company field.
func (iuo *InsuranceUpdateOne) SetCompany(s string) *InsuranceUpdateOne {
	iuo.mutation.SetCompany(s)
	return iuo
}

// AddInsuranceofIDs adds the insuranceof edge to Ambulance by ids.
func (iuo *InsuranceUpdateOne) AddInsuranceofIDs(ids ...int) *InsuranceUpdateOne {
	iuo.mutation.AddInsuranceofIDs(ids...)
	return iuo
}

// AddInsuranceof adds the insuranceof edges to Ambulance.
func (iuo *InsuranceUpdateOne) AddInsuranceof(a ...*Ambulance) *InsuranceUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return iuo.AddInsuranceofIDs(ids...)
}
...
// RemoveInsuranceofIDs removes the insuranceof edge to Ambulance by ids.
func (iuo *InsuranceUpdateOne) RemoveInsuranceofIDs(ids ...int) *InsuranceUpdateOne {
	iuo.mutation.RemoveInsuranceofIDs(ids...)
	return iuo
}

// RemoveInsuranceof removes insuranceof edges to Ambulance.
func (iuo *InsuranceUpdateOne) RemoveInsuranceof(a ...*Ambulance) *InsuranceUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return iuo.RemoveInsuranceofIDs(ids...)
}
...
func (iuo *InsuranceUpdateOne) sqlSave(ctx context.Context) (i *Insurance, err error) {
	...
	if nodes := iuo.mutation.RemovedInsuranceofIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   insurance.InsuranceofTable,
	...
	if nodes := iuo.mutation.InsuranceofIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   insurance.InsuranceofTable,
